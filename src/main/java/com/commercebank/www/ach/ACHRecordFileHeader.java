 ...
 *
 */
package com.commercebank.www.ach;

public class ACHRecordFileHeader extends ACHRecord {

	private String priorityCode = spaceFill(2);

    private String immediateDestination = spaceFill(10);

    private String immediateOrigin = spaceFill(10);

    private String fileCreationDate = spaceFill(6);

    private String fileCreationTime = spaceFill(4);

    private String fileIdModifier = spaceFill(1);

    private String recordSize = spaceFill(3);

    private String blockingFactor = spaceFill(2);

    private String formatCode = spaceFill(1);

    private String immediateDestinationName = spaceFill(23);

    private String immediateOriginName = spaceFill(23);

    private String referenceCode = spaceFill(8);
