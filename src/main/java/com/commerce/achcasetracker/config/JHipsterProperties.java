package com.commerce.achcasetracker.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ACHCaseTracker@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ACHCaseTracker API";

        private String description = "ACHCaseTracker API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ACHCaseTracker";
