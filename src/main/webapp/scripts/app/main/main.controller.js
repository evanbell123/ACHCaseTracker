...
angular.module('achcasetrackerApp')
    ...
    .controller('CasesController', ['$scope', 'Principal', '$location', '$http', '$timeout', 'uiGridConstants', function($scope, Principal, $location, $http, $timeout, uiGridConstants) {
        Principal.identity().then(function(account) {
            $scope.account = account;
            $scope.isAuthenticated = Principal.isAuthenticated;
        });
    ...
    .controller('ImportController', function($scope, Principal) {
        Principal.identity().then(function(account) {
            $scope.account = account;
            $scope.isAuthenticated = Principal.isAuthenticated;
        });
    ...
    .controller('CaseFormController', ['$scope', 'Principal', '$http', function($scope, Principal, $http, formlyVersion) {
        Principal.identity().then(function(account) {
            $scope.account = account;
            $scope.isAuthenticated = Principal.isAuthenticated;
        });
