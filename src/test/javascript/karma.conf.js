...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'main/webapp/bower_components/angular-ui-router.stateHelper/statehelper.js',
            ...
            'main/webapp/bower_components/angular-formly-templates-bootstrap/dist/angular-formly-templates-bootstrap.js',
            'main/webapp/bower_components/angular-ui-grid/ui-grid.js',
            'main/webapp/bower_components/csv-js/csv.js',
