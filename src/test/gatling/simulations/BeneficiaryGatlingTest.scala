...
/**
 * Performance test for the Beneficiary entity.
 */
class BeneficiaryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Beneficiary entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all beneficiaries")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created beneficiary")
                .get("${new_beneficiary_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created beneficiary")
            .delete("${new_beneficiary_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
